...
#define UE_PROJECT_NAME MakeGunFirstPerson
#define UE_TARGET_NAME MakeGunFirstPersonEditor
#define UE_MODULE_NAME "MakeGunFirstPerson"
...
#define MAKEGUNFIRSTPERSON_API DLLEXPORT
